...
const DashBoard_HealthTips = () => {
  return (
    <>
        <section className="main-yoga-container" id="health_tips">
            <div className="container mb-5">
                <div className="row yoga-section">
                    {/* --------------main yoga left side---------------- */}
                    <div className="col-12 col-lg-5 text-center main-yogasection-image">
                        <img className="img-fluid image-shadow" src="./Assets/health.jpg" alt="image" />
                    </div>
                    ...
                    <div className="col-11 col-lg-7 yoga-container">
                        ...
                        <div className="row">
                            ...
                            <form className="d-flex">        
                                <Links to="/"><button className="btn btn-style" type="submit">Take a Look</button></Links>
                            </form>
                        </div>
                    </div>
                </div>
...
export default  DashBoard_HealthTips;