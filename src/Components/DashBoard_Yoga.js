...
const  DashBoard_Yoga = () => {
  return (
    <>
        <section className="main-yoga-container" id="yoga">
            <div className="container mb-5">
                <div className="row yoga-section">
                    {/* --------------main yoga left side---------------- */}
                    <div className="col-12 col-lg-5 text-center main-yogasection-image">
                        <img className="img-fluid image-shadow" src="./Assets/online-yoga.jpg" alt="image" />
                    </div>
                    ...
                    <div className="col-11 col-lg-7 yoga-container">
                        ...
                        <div className="row">
                            ...
                            <form className="d-flex">        
                                <Links to="/yogalist"><button className="btn btn-style" type="submit">Practice</button></Links>
                            </form>
                        </div>
                    </div>
                </div>
